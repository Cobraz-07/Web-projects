import { o as objectType, h as dateType, n as numberType, i as arrayType, s as stringType, A as AstroError, U as UnknownContentCollectionError, a as createComponent, R as RenderUndefinedEntryError, u as unescapeHTML, r as renderTemplate, j as escape, k as renderUniqueStylesheet, l as renderScriptElement, p as createHeadAndContent, f as renderComponent } from './astro/server_DPj_SWeM.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_DEh8wb6h.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://rafa-dev-blog.vercel.app/", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_Bivd5buX.mjs').then(n => n._);
